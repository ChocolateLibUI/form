...
export interface SelectionBase<T> { index: number, selection: SelectorOption<T> }

/**Base for number elements elements*/
export abstract class SelectorBase<T, S extends SelectionBase<T>> extends FormElement<T> {
    ...
    protected abstract _addSelection(selection: SelectorOption<T>, index: number): S
